...
* Sniff the cookie in an insecure network. A wireless LAN can be an example of such a network. In an unencrypted wireless LAN, it is especially easy to listen to the traffic of all connected clients. For the web application builder this means to _provide a secure connection over TLS_. In Rails 3.1 and later, this could be accomplished by always forcing TLS connection in your application config file:
