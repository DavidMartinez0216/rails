...
module ActionView
  module Helpers # :nodoc:
    ...
    # (DNS, TLS) and the overall browser connection limits may result in this
    ...
    # particularly useful for serving assets from an TLS-protected page. The
    # example proc below disables asset hosting for HTTPS connections, while
    # still sending assets for plain HTTP requests from asset hosts. If you don't
    # have TLS certificates for each of the asset hosts this technique allows you
